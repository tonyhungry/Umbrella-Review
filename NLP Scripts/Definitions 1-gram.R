...
ggplot(df_plot) + geom_bar(aes(reorder(term,freq),freq, fill = freq), stat = 'identity') + 
  scale_fill_viridis_c() +
  theme_minimal() + 
  theme() + labs(title = "Infrastructure Resilience Unigrams",x="Terms", y="Count", fill="Frequency") + coord_flip() 
...
ggplot(df_plot) + geom_bar(aes(reorder(term,freq),freq, fill = freq), stat = 'identity') + 
  scale_fill_viridis_c() +
  theme_minimal() + 
  theme() + labs(title = "Organizational Resilience Unigrams",x="Terms", y="Count", fill="Frequency") + coord_flip() 
...
ggplot(df_plot) + geom_bar(aes(reorder(term,freq),freq, fill = freq), stat = 'identity') + 
  scale_fill_viridis_c() +
  theme_minimal() + 
  theme() + labs(title = "Community Resilience Unigrams",x="Terms", y="Count", fill="Frequency") + coord_flip() 
